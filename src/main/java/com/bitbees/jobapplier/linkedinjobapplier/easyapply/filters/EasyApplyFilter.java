...
@Setter
@Configuration
@ConfigurationProperties(prefix = "easy-apply.search.filter")
public class EasyApplyFilter {
    ...
    public enum Title {
        SOFTWARE_ENGINEER, DEVOPS_ENGINEER, CLOUD_ENGINEER, FULL_STACK_ENGINEER, INFORMATION_TECHNOLOGY_ARCHITECT, APPLICATION_DEVELOPER, PLATFORM_ENGINEER, SENIOR_SOFTWARE_ENGINEER, DATA_ENGINEER, JAVA_SOFTWARE_ENGINEER, SITE_RELIABILITY_ENGINEER;
    }
