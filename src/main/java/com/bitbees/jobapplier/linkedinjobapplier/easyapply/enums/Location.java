...
public enum Location {
    ...
    BENGALURU(By.xpath("//legend[text()='Location filter']/following-sibling::div//span[starts-with(normalize-space(.),'Bengaluru') or starts-with(normalize-space(.),'Bangalore')]")),
